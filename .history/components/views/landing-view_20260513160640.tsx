...
<section className="w-full bg-white py-12 px-6">
  <div className="mx-auto max-w-5xl">
    <div className="flex flex-col md:flex-row justify-between items-end mb-8 gap-4">
      <div>
        <h3 className="text-2xl font-black text-[#1e293b] tracking-tight">
          Nous trouver <span className="text-[#10B981]">.</span>
        </h3>
        <p className="text-slate-500 font-medium mt-2">
          L'Hôpital du Mali est situé à Missabougou, accessible via le 3ème Pont.
        </p>
      </div>
      <a 
        href="https://maps.app.goo.gl/yTzUNqzTUQ4R58BK9" 
        target="_blank" 
        rel="noopener noreferrer"
        className="flex items-center gap-2 text-sm font-bold text-[#10B981] hover:underline"
      >
    ...
    <div className="relative w-full h-[400px] rounded-3xl overflow-hidden shadow-2xl shadow-emerald-900/10 border-4 border-white">
      <iframe 
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m12!1m3!1d3893.4475510668045!2d-7.913787224213038!3d12.63408478765406!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x4c71a4a7144ac0e7!2zSMO0cGl0YWwgZHUgTWFsaQ!5e0!3m2!1sfr!2sml!4v1715609200000!5m2!1sfr!2sml"
        width="100%" 
        height="100%" 
