...
<div className="flex items-center cursor-pointer group" onClick={() => onNavigate("home")}>
  ...
  >
    <text x="0" y="30" font-family="Arial, sans-serif" font-size="28" font-weight="bold" fill="#1e293b">Rang</text>
    <text x="75" y="30" font-family="Arial, sans-serif" font-size="32" font-weight="bold" fill="#10B981">+</text>
  </svg>
  
  {/* On peut garder le petit texte "Hôpital du Mali" juste à côté ou en dessous si tu veux */}
  <div className="hidden sm:flex flex-col ml-2 border-l border-slate-200 pl-2">
    <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">Hôpital</span>
    <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">du Mali</span>
  </div>
</div>
