        ...
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 lg:px-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <span className="text-lg font-bold text-foreground leading-tight">Rang+</span>
              <span className="text-[10px] text-muted-foreground leading-tight">Hopital du Mali</span>
            </div>
          </div>
