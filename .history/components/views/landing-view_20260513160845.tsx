...
<section className="w-full bg-slate-50 py-16 px-6">
  <div className="mx-auto max-w-5xl">
    <div className="flex items-center justify-between mb-6">
      <h3 className="text-xl font-black text-[#1e293b] uppercase tracking-wider">
        Localisation<span className="text-[#10B981]">.</span>
      </h3>
      <a 
        href="https://www.google.com/maps/dir/?api=1&destination=Hôpital+du+Mali+Missabougou" 
        target="_blank" 
        rel="noopener noreferrer"
        className="flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-slate-200 text-xs font-bold text-[#1e293b] hover:shadow-md transition-all"
      >
        <MapPin className="size-3.5 text-[#10B981]" />
        ITINÉRAIRE
      </a>
    </div>

    {/* Carte sans fioritures */}
    <div className="w-full h-[450px] rounded-[2rem] overflow-hidden shadow-xl border border-white">
      <iframe 
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3893.635817293548!2d-7.925434623946067!3d12.604620022137943!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xef6126ac36d43cc9%3A0x4c71a4a7144ac7e7!2zSMO0cGl0YWwgZHUgTWFsaQ!5e0!3m2!1sfr!2sml!4v1715600000000!5m2!1sfr!2sml"
        width="100%" 
        height="100%" 
        style={{ border: 0 }} 
        allowFullScreen 
