...
<div className="flex items-center gap-3 group cursor-pointer" onClick={() => onNavigate("home")}>
  <div className="flex size-11 items-center justify-center rounded-xl bg-[#005a32] shadow-md transition-transform group-hover:scale-105">
    {/* Croix médicale épurée */}
  ...
  <div className="flex flex-col">
    <span className="text-xl font-black text-[#171717] leading-none tracking-tight">
      RANG<span className="text-[#005a32]">+</span>
    </span>
