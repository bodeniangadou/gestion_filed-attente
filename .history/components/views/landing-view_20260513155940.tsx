...
Hôpital du Mali</span>
  ...
  {/* Nom de l'app avec ton design validé */}
  ...
  {/* Mention de l'hôpital avec le style qu'on a validé ensemble */}
  <span className="text-[10px] font-extrabold text-background/40 uppercase tracking-[0.2em] mt-2 group-hover:text-[#10B981] transition-colors">
    Hôpital du Mali
  </span>
  
  {/* Une petite barre discrète pour souligner le tout */}
