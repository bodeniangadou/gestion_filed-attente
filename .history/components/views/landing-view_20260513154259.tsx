...
<div className="flex items-center gap-3">
  <div className="flex size-10 items-center justify-center rounded-xl bg-emerald-500 shadow-lg shadow-emerald-200">
    {/* Ta croix médicale blanche */}
  ...
  <div className="flex flex-col">
    <span className="text-xl font-extrabold text-slate-900 leading-tight tracking-tight">
      Rang<span className="text-emerald-500">+</span>
    </span>
