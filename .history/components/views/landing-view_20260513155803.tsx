...
export function LandingView({ onNavigate, onScanQR, onTakeTicket, onLogin }: LandingViewProps) {
  ...
  <div className="flex flex-col items-start">
    ...
    <span className="text-[11px] font-semibold text-[#1e293b]/70  tracking-tight mt-0.5">
Hôpital du Mali</span>
  ...
  {/* Nom de l'app en grand pour la marque */}
  <span className="text-xl font-black text-background leading-none tracking-tight">
    RANG<span className="text-[#10B981]">+</span>
  </span>
  
  {/* Mention de l'hôpital stylisée comme en haut */}
  <span className="text-[10px] font-extrabold text-background/50 uppercase tracking-[0.15em] mt-1.5">
    Hôpital du Mali
  </span>
</div>
              </div>
