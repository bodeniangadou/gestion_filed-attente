...
export function LandingView({ onNavigate, onScanQR, onTakeTicket, onLogin }: LandingViewProps) {
  ...
  {/* Logo depuis ton fichier public */}
...
{/* Section Carte Minimaliste */}
{/* Section Carte Equilibrée */}
<section className="w-full bg-white pt-16">
  <div className="mx-auto max-w-6xl px-6">
    <div className="flex items-center gap-4 mb-8">
      <h3 className="text-sm font-black text-[#1e293b] uppercase tracking-[0.2em]">
        Localisation
      </h3>
      <div className="h-[1px] flex-1 bg-slate-100"></div> {/* Ligne de rappel minimaliste */}
      <a 
        href="https://www.google.com/maps/dir/?api=1&destination=Hôpital+du+Mali+Missabougou" 
        target="_blank" 
        rel="noopener noreferrer"
        className="text-[10px] font-bold text-[#10B981] uppercase tracking-widest hover:opacity-70 transition-opacity"
      >
        Itinéraire →
      </a>
    </div>
  ...
  {/* Carte pleine largeur ou avec un arrondi très léger, sans bordure */}
  <div className="mx-auto max-w-6xl px-6 pb-16">
    <div className="w-full h-[400px] rounded-xl overflow-hidden grayscale-[0.1] contrast-[1.02]">
      <iframe 
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3893.578631168444!2d-7.925585023964522!3d12.608405087673523!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xef614da6d6d43cf1%3A0x4c71a4a7144ac0e7!2zSMO0cGl0YWwgZHUgTWFsaQ!5e0!3m2!1sfr!2sml!4v1715600000000!5m2!1sfr!2sml"
        width="100%" 
        height="100%" 
        style={{ border: 0 }} 
        allowFullScreen 
      ...
      <footer id="contact-section" className="px-6 py-12 bg-foreground text-background">
        <div className="mx-auto max-w-4xl">
          <div className="grid gap-8 lg:grid-cols-3 mb-8">
            <div>
             <div className="flex flex-col mb-6 group cursor-pointer" onClick={() => onNavigate("home")}>
  ...
  <span className="text-[10px] font-extrabold text-background/40   italic tracking-[0.2em] mt-2 group-hover:text-[#10B981] transition-colors">
    Hôpital du Mali
  </span>
  
  <div className="h-1 w-8 bg-[#10B981] mt-3 rounded-full opacity-50"></div>
</div>
