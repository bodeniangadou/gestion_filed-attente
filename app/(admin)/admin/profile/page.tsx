          ...
          <CardContent className="p-6">
            ...
            <div className="flex items-center justify-between mb-5">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-gray-400 ml-1">• Gérer vos informations</span>
              </div>
            ...
            {/* ===== DÉCONNEXION - taille moyenne ===== */}
            <motion.button
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="h-7 px-5 text-xs border border-red-200 hover:border-red-500 hover:bg-red-50 hover:text-red-600 text-gray-500 rounded-lg transition-all flex items-center justify-center gap-1.5 font-medium mt-2"
              onClick={logout}
            >
